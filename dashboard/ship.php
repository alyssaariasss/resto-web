...
if (isset($_GET['confirmid'])) {
  ...
  if (mysqli_num_rows($result)) {
      ...
      $mail->Body = "<h1>Shipping update from D' Nacars' Place</h1><hr><br>" . "Hi ".$fname.","."<br><br>This is a follow up email to let you know that your recent order ".$order_id." has been shipped to
      your provided address. Here's what we shipped: <br><br><hr>" . "<h4>Order Details</h4>" .
